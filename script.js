...
event.preventDefault(); // Prevent the default form submission
    ...
    const yourShare = remainingProfit * 0.5; // 50% your share
    const partnerShare = remainingProfit * 0.5; // 50% partner's share
    //display summary
    ...
    summaryDiv.innerHTML = `
        ...
        <p><strong> Reinvestment (20%):</strong> $${reinvestment.toFixed(2)}</p>
        <p><strong> Remaining Profit:</strong> $${remainingProfit.toFixed(2)}</p>
        <p><strong> Your Share (50%):</strong> $${yourShare.toFixed(2)}</p>
        <p><strong> Partner's Share (50%):</strong> $${partnerShare.toFixed(2)}</p> 
